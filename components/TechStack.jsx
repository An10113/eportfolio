    ...
    <div id="techstack" className="p-5">
      <div className="max-w-[1000px] mx-auto ">
        ...
        <div className="flex flex-wrap">
          {techstack.map((data) => (
            <figure class="techstack__language">
              <img src={data.img} alt="" />
              <span class="language__name xl:text-3xl text-base md:text-2xl">{data.name}</span>
            </figure>
          ))}
        </div>
      </div>
